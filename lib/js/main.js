...
function getData(userID) {
    ...
    document.getElementById("cat1-name").innerHTML = identifier;
    document.getElementById("cat1-Loc").innerHTML = genLoc;
    document.getElementById("cat1-specLoc").innerHTML = specLoc;
